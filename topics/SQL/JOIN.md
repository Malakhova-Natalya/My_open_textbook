...
- при джойне система берёт значение в одной таблице и далее ходит по **каждой** строке другой таблицы и проверяет значения на равенство.

- NULL не равен ни себе, и ничему другому.
