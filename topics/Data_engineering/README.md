...
**Change Data Structure (CDS)** — это структура данных, которая используется для хранения и обработки изменений в других структурах данных. Она позволяет отслеживать изменения и применять их к исходной структуре данных без потери информации.
